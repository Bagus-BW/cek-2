<template>
  <div class="absolute top-16 right-10 lg:right-28 w-[250px] border bg-white rounded-[20px] p-4">
    ...
    <div class="h-1 w-full border-t my-5" />
    <a
      href=""
      class="flex gap-x-3"
    >
      ...
      <span>Dashboard Travel Agency</span>
    </a>
  </div>
</template>
<script>
